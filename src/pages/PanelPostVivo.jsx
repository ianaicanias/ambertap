...
export default function PanelPostVivo() {
  ...
  useEffect(() => {
    ...
    const canal = supabase
      ...
      .on('postgres_changes', { event: 'INSERT', schema: 'public', table: 'pedidos' }, () => { cargarPedidos(vivoSel) })
      .on('postgres_changes', { event: 'UPDATE', schema: 'public', table: 'pedidos' }, () => { cargarPedidos(vivoSel) })
      .on('postgres_changes', { event: 'INSERT', schema: 'public', table: 'pagos' }, () => { cargarPedidos(vivoSel) })
      .on('postgres_changes', { event: 'UPDATE', schema: 'public', table: 'pagos' }, () => { cargarPedidos(vivoSel) })
      .subscribe()
  ...
  return (
    <div className="overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal">
        ...
        <input className="input" value={agencia} onChange={e => setAgencia(e.target.value)} placeholder="Ej: OCA, Correo, abitab..." />
